...
class AnalyticsDaemon(BaseWorkerThread):
    ...
    def algorithm(self, parameters = None):
        ...
        try:
            ...
            self.config.max_files_per_transfer = param['rows'][0]['key']
        except Exception, e:
        ...
        # TODO: Remove this call since it is not needed anymore
    ...
    def updateFilesSummaries(self):
        ...
        try:
            ...
            # TODO: Evaluate the stale=ok to optimize the couchdb calls
