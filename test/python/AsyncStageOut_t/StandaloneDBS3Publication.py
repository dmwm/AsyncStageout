...
class TestDBS3Publication(unittest.TestCase):
    ...
    def dbs3_publish_helper(self, input_dataset):
        ...
        dummyfailFiles, toPublish = self.publisher.clean(lfn_ready, toPublish)
        ...
        failed, dummydone, dbsResults = self.publisher.publishInDBS3(userdn=self.publisher.userDN, sourceURL=TEST_DBS3_READER,
